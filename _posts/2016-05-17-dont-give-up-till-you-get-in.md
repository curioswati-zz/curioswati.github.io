...
### The Introduction ###
I got to know about this program from  my college senior [Shaifali Agrawal](http://exploreshaifali.github.io/) [(@exploreshaifali)](https://twitter.com/exploreshaifali).
Who also has been a previous [Outreachy'9](https://wiki.gnome.org/OutreachProgramForWomen/2014/DecemberMarch#Participating_Organizations/) (when it was OPW) as well as a [GSoC'15](https://www.google-melange.com/gsoc/project/details/google/gsoc2015/shifali/5634387206995968) intern and of course an open source enthusiast just like me.
Thanks to her for introducing and guiding me through this path.

In the beginning, I just knew that it is some program which is very difficult to get into and It will provide me learning.
Later on, while discussing various things with [@exploreshaifali](https://twitter.com/exploreshaifali),
about the internship, her mentor, her co-interns, the work she was doing etc.,
I understood the importance of this opportunity.

There was learning in various aspects. You learn how to work with people miles away from you.
Where in confusion, you can't just sit in front and discuss things, you need to be very elaborative that you can make your points clear.
_**"The art of Communicating"**_.

You work on a project that has numerous eyes on it. This enforces standards implicitly,
you don't make excuses then (for e.g. 'I didn't get time to write comment'). Because It's like an unwritten rule here.
_**"Coding Standards and Best Practices"**_.

It makes you learn to have patience. Yes, that is very important when you are in open source.
This is the way how they maintain quality and stability in the product.
Code reviews, approvals, many things before your code is live. It removes any traces of mistakes if you did any.
_**"Patience"**_.
...
Since I and [@exploreshaifali](https://twitter.com/exploreshaifali) are Pythonistas, so what she/I learned was more pythonic. Design Patterns, Testing Approaches, and Frameworks, advanced concepts of the language.
_**"Technical"**_. 

And of course, you get a fair amount of money :-P, that can help you get more opportunities for learning.
<br>
<br>

### The Beginning ###
So, After watching her go through this amazing process, I got interested in it too.
And as I mentioned above, it is a treasure box of learning so how could I miss it.
...
But since I was too late ( I started around 7 days before the application deadline), I had no confidence and faith in my efforts. so I gave up soon.
...
What matters is, how much faith you have in yourself and till when are you determined not to give up.
...
Had I talked to the coordinators, I might have got some way out of the fears.
...
I started along with one of my classmate and a senior ([Rohini Choudhary](https://github.com/enthurohini) ([@rohini241](https://twitter.com/rohini241))). We all first scanned the organization list.
Then reached the mentors individually for projects of our interests.
We spent a lot of time doing that only. I guess over planning kills the plan itself.
Same thing happened to us. We gave too much time selecting the organization.
Although It is good to give time to select the project, because you have to work on it for a fairly long duration of time.

> I might sound contradicting, but this is the thing; you need to find the boundary yourself.
Honestly, I couldn't; and paid off.

What I learned, this time, was that efforts matter but they should be in right direction.
You should take enough time to select project but not much that you don't get time to understand the project.
...
Among three of us, only [@rohini241](https://twitter.com/rohini241) got interested in the project. Two of us were still not convinced. But still we tried.
...
[@rohini241](https:/twitter.com/rohini241) successfully set it up and also fixed few issues. She continued.
...
Keep this in mind. It's not only for this program but It fits in anything you do.
Because I assure you, It led us nowhere.

<br>
So this attempt also failed. Anyways, I am happy that one of us ([@rohini241](https://twitter.com/rohini241)) succeeded.
She got selected in that round for a project in Murano Dashboard for [OpenStack](https://wiki.openstack.org/wiki/Outreachy).

What I learned from this attempt was (and this from [@rohini241's](https://twitter.com/rohini241) efforts more than my own experience) that you need to have focus.
...
Got back my confidence and hope.
...
I compared my capabilities with others. I measured my efforts on a scale that was nonexistent.

It was around a month before the application submission deadline. I was looking for organizations in GSoC listing. 
Looked through many of them, their project ideas. Joined several mailing lists.
Set up development environments for around 3-4 of them (which I found of interest of course).
<br>
<br>
...
Even after submitting the application, I kept the communication link. I used to ping the mentors constantly for new tasks.
